...
public class GUI extends JFrame {
	...
	private JList<String> groupList; // the list of newsgroups
	private DefaultListModel<String> articleModel;
	private JList<String> articleList; // the list of articles
	...
	public GUI(String title, CommandHandler comHand, boolean logged) {
		...
		groupList = new JList<String>(groupModel);
		groupList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		articleModel = new DefaultListModel<String>();
		articleList = new JList<String>(articleModel);
